...
import { checkPassword, generateDeliveryCode } from '../../../../services'
import { useDeliveryStore } from '../state'

export function PasswordConfirmation({ navigation }) {
  const { selectedRaffleItemId, setCode } = useDeliveryStore()
  ...
  async function generate() {
    ...
    const [isGenerateOk, generateData] = await generateDeliveryCode(
      selectedRaffleItemId
    )
    ...
    setCode(generateData.code)

    navigation.navigate('raffleCode')
  }
